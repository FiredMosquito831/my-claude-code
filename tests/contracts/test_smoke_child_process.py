...
def test_my_claude_code_serve_command_uses_cli_entrypoint() -> None:
    assert cmd_my_claude_code_serve() == [
        child_process.python_exe(),
        "-c",
        "from my_claude_code.cli.entrypoints import serve; serve()",
    ]
